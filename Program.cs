    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < cntTowns; i++)
            {
                ...
                theTown.Name = sName; 
                theTown.Country = sCountry; theTown.Region = sRegion;
                theTown.Population = int.Parse(sPopulation); 
                theTown.YearIncome = double.Parse(sYearIncome); theTown.Square = double.Parse(sSquare);
            ...
            foreach (Town t in arrTowns)
            {
                ...
                Console.WriteLine("--------------------------------------");
                Console.WriteLine("Країна: " + t.Country); Console.WriteLine("Регiон: " + t.Region);
